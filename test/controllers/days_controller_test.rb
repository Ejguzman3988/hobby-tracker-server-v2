...
class DaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create day" do
    assert_difference('Day.count') do
      post days_url, params: { day: { daily_stat_id: @day.daily_stat_id, day: @day.day, timer_id: @day.timer_id } }, as: :json
    end
  ...
  test "should update day" do
    patch day_url(@day), params: { day: { daily_stat_id: @day.daily_stat_id, day: @day.day, timer_id: @day.timer_id } }, as: :json
    assert_response 200
  end
